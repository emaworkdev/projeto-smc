...
import 'package:server_smc/repositories/question_repository.dart';
...
class QuestionController {
  ...
  Future<Response> created(Request request) async {
    try {
      String id = '0';
      final obj = QuestionModel.fromJson(await request.readAsString());

      id = await _questionRepository.save(obj);
  ...
  Future<Response> delete(Request request) async {
    try {
      ...
      await _questionRepository.delete(jsonRQ['id']);
  ...
  Router get router => _$QuestionControllerRouter(this);
}
